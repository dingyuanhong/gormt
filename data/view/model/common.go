...
import (
	...
	"github.com/dingyuanhong/gormt/data/view/cnf"
	"github.com/dingyuanhong/gormt/data/view/genfunc"
...
func getTypeName(name string, isNull bool) string {
	...
	panic(fmt.Sprintf("type (%v) not match in any way.maybe need to add on (https://github.com/dingyuanhong/gormt/blob/master/data/view/cnf/def.go)", name))
}
